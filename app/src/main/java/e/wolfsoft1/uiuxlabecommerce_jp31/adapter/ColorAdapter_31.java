...
import e.wolfsoft1.uiuxlabecommerce_jp31.R;
import e.wolfsoft1.uiuxlabecommerce_jp31.model.Color_Model;

public class ColorAdapter_31 extends RecyclerView.Adapter<ColorAdapter_31.MyColorHolder> {

    private final Context context;
    private final ArrayList<Color_Model> color_modelArrayList;
    private int position;

    public ColorAdapter_31(Context context, ArrayList<Color_Model> color_modelArrayList) {
    ...
    public MyColorHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(context).inflate(R.layout.item_color_31, viewGroup, false);
